...
from hummingbot.connector.exchange.gsudemo import gsudemo_constants as CONSTANTS, gsudemo_web_utils as web_utils
from hummingbot.connector.exchange.gsudemo.gsudemo_auth import GsudemoAuth
...
if TYPE_CHECKING:
    from hummingbot.connector.exchange.gsudemo.gsudemo_exchange import GsudemoExchange


class GsudemoAPIUserStreamDataSource(UserStreamTrackerDataSource):
    ...
    def __init__(self,
                 ...
                 connector: 'GsudemoExchange',
                 api_factory: WebAssistantsFactory,
                 domain: str = CONSTANTS.DEFAULT_DOMAIN):
        super().__init__()
        self._auth: gsudemoAuth = auth
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        GSU-demo does not require any channel subscription.
    ...
    async def _get_listen_key(self):
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.GSUDEMO_USER_STREAM_PATH_URL, domain=self._domain),
                method=RESTMethod.POST,
                throttler_limit_id=CONSTANTS.GSUDEMO_USER_STREAM_PATH_URL,
